...
class ProductsWithoutTabScreen extends Component {
  constructor(props) {
    super(props);
  ...
  getProducts = async (page = 1) => {
    const {_doProducts} = this.props;
    const {productData, category, isRefreshing} = this.state;
...
export default connect(ProductsWithoutTabScreen);
